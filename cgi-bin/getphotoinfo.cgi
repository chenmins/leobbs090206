...
<!--
//初始化内容值
var targetTd = parent.document.getElementById('followTd$dispinfo');
var targetImg = parent.document.getElementById('followImg$dispinfo');
if (targetTd) { targetTd.innerHTML='$out'; }
//已读取
